...
Casper is a search tool that will eventually streamline the complex world of Reserve Bank of India (RBI) notifications for legal professionals. 

## Context:
Reserve Bank of India, the banking and foreign exchange regulator, is responsible for multiple areas such as Monetary Policy, Banking System, Foreign Exchange Management, and Payment Systems (e.g., UPI) in the country. Lawyers have to sift through approximately 12,000 notifications organized chronologically on the regulator's website to provide legal solutions to their clients' problems.
